    ...
    var bigAutocomplete = new function () {
        ...
        this.init = function () {
            ...
            $("#bigAutocompleteContent").delegate("tr", "mouseover", function () {
                ...
                $(this).addClass("ct");
                var GoodsPic = $(this).find("span:last").attr("pic");
                if (GoodsPic!="") {
                                $("#picture").css("display", "block")
                                $("#picture").find("img").attr('src', GoodsPic)
                }
                else {
            ...
            $("#bigAutocompleteContent").delegate("tr", "click", function () {
                bigAutocomplete.currentInputText.val($(this).find("span:last").html());
                ...
                switch (event.keyCode) {
                    case 40://向下键
                        ...
                        if ($nextSiblingTr.length > 0) {//有下一行时（不是最后一行）
                            ...
                            $this.val($nextSiblingTr.find("span:last").html());//选中行内容设置到输入框中
                    ...
                    case 38://向上键
                        ...
                        if ($previousSiblingTr.length > 0) {//有上一行时（不是第一行）
                            ...
                            $this.val($previousSiblingTr.find("span:last").html());//选中行内容设置到输入框中
